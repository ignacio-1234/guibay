    ...
    <div className="min-h-screen bg-surface-muted flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-xl font-semibold text-gray-900">Crea tu cuenta gratis</h1>
          <p className="mt-1 text-sm text-gray-500">Sin tarjeta de crédito requerida</p>
        </div>
